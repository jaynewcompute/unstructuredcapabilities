...
## what We Believe
- True, scientific reasoning will emerge from larger AI systems.
- Increasingly, the data engineering role will be the bottleneck of AI. Everyone team will need a data engineer, or have some one who can effectively become one (so we need better tools)
- Open collaboration is the way forward.
- The data community holds immense potential.
- In [Dataism](https://en.wikipedia.org/wiki/Dataism#:~:text=Dataism%20is%20a%20term%20that,New%20York%20Times%20in%202013).
- Tools must be built to empower the open data community.
...
- [Data scientists spend too much time cleaning data](https://www.forbes.com/sites/gilpress/2016/03/23/data-preparation-most-time-consuming-least-enjoyable-data-science-task-survey-says/?sh=28e1f5556f63).
